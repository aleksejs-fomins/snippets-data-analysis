...
from aux import randstat, dataanalysis, infotheory
...
shannonH1 = infotheory.shannonEntropy1Dbin(width1, histy1)
shannonH2 = infotheory.shannonEntropy1Dbin(width2, histy2)
shannonH3 = infotheory.shannonEntropy1Dbin(width3, histy3)
